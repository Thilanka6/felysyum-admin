    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <h1 className="text-lg md:text-xl font-bold text-gray-900">Paid Withdrawals</h1>
                {/* Breadcrumbs could go here if needed */}
                <span className="text-xs text-gray-500">Pages {'>'} Paid Withdrawals</span>
            </div>
            ...
            <div className="overflow-hidden rounded-xl bg-white shadow-sm border border-gray-100">
                <div className="border-b border-gray-100 bg-gray-50/50 px-4 py-3 md:px-6 md:py-4">
                    <h2 className="text-sm font-bold text-gray-900 md:text-base">Paid Withdrawals</h2>
                </div>
                    ...
                    <table className="w-full text-left text-xs text-gray-600">
                        <thead className="bg-gray-50 text-[10px] uppercase text-gray-500">
                            <tr>
                                ...
                                <th className="px-4 py-2 font-semibold whitespace-nowrap md:px-6 md:py-3 text-center">Status</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap md:px-6 md:py-3">WD0987</td>
                                <td className="px-4 py-2 whitespace-nowrap text-right md:px-6 md:py-3">1,250.00</td>
                                ...
                                <td className="px-4 py-2 whitespace-nowrap text-gray-500 md:px-6 md:py-3">2026-02-20</td>
